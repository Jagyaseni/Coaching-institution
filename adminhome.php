	...
	<div class="container">
	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav">
	        	<li class="dropdown">
		            <a href="adminhome.php"><i class="fa fa-user"></i><span>Home</span></a>
		        </li>
		        <li class="dropdown">
		            <a href="viewusers.php"><i class="fa fa-user"></i><span>View Users</span></a>
		        </li>
		        <li class="dropdown">
		        ...
		        <li class="dropdown">
		            <a href="index.php"><i class="fa fa-user"></i><span>logout</span></a>
		        </li>
		        <li class="dropdown">
